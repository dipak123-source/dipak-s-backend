...
const loginUser = asyncHandler( async (req,res)=>{
    ...
    console.log("the access email is : ",email);
...
const channel = await User.aggregate([
        ...
        {
            $lookup: {//it is used for left router join between two collection.It allows you to bring in related data from another collection and combine it with the documents currently being processed in the pipeline.
                from: "subscriptions",
                localField: "_id",
        ...
        {
            $addFields: {// it is used to add new field or modify the existing field in each document as it passes through the pipeline
                subscribersCount: {
                    $size: "$subscribers"
                },
        ...
        {
            $project: {//it is used for giving the selected thinks to the user
                fullname: 1,
                username: 1,
                avatar: 1,
                coverImage: 1,
    ...
    console.log("print the channel value",channel)
    if(!channel?.length){
